...
At least one allocation , the two slices create two new arrays plus vcat creates another array.
"""
...
Three allocations: two from the slices and one from vcat
"""
